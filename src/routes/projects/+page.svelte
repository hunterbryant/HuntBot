...
>
	...
	>
		<div
			class="col-start-1 col-end-6 mb-8 mt-12 flex flex-col justify-end rounded text-6xl font-bold tracking-tighter text-stone-800 sm:col-start-4 sm:col-end-7 sm:mt-0 sm:h-[24.5rem] sm:text-5xl md:col-end-8 md:mb-32 md:text-6xl lg:col-end-10 lg:text-7xl xl:text-8xl"
		>
