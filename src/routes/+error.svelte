...
>
	...
	>
		<div
			class="text-stone-800 col-start-1 col-end-6 mb-10 mt-12 flex flex-col justify-end rounded text-7xl font-bold tracking-tighter dark:text-stone-200 sm:col-start-4 sm:col-end-7 sm:mb-16 sm:mt-0 sm:h-[24.5rem] md:col-end-8 md:text-8xl lg:col-end-10 lg:text-9xl"
		>
			<h2
		...
		<div
			class="text-stone-500 col-start-1 col-end-6 flex flex-col gap-4 text-balance text-2xl font-medium leading-none tracking-tight sm:col-start-4 sm:col-end-7 md:col-end-8 md:text-3xl lg:col-end-9"
		>
			{message}
		</div>
	</div>
