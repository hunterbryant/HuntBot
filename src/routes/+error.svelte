...
>
	...
	>
		<div
			class="col-start-1 col-end-6 mb-10 mt-12 flex flex-col justify-end rounded text-7xl font-bold tracking-tighter text-stone-800 sm:col-start-4 sm:col-end-7 sm:mb-16 sm:mt-0 sm:h-[24.5rem] md:col-end-8 md:text-8xl lg:col-end-10 lg:text-9xl dark:text-stone-200"
		>
			<h2
