...
>
	...
	>
		<div
			class="col-start-1 col-end-6 flex flex-col justify-start gap-16 overflow-hidden sm:col-start-4 sm:col-end-7 md:col-end-8 md:mb-32 lg:col-end-10"
		>
			<PrismicImage
				class="aspect-video rounded object-cover sm:h-[calc(50svh-6rem)] sm:rounded-b"
