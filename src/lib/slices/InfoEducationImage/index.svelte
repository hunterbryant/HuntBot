...
<section
	...
	class="col-span-full mb-8 grid grow grid-cols-subgrid items-stretch gap-4 sm:mb-0"
>
	<!-- Out of box metadata -->
	<div
	...
	<!-- Education Block -->
	<div
		class="col-span-4 col-start-1 row-start-4 flex flex-col gap-8 text-balance text-stone-900 *:row-span-1 *:flex *:flex-col *:gap-4 sm:col-span-3 sm:col-start-4 sm:row-start-3 md:row-start-2"
	>
