...
>
	...
	<!-- Text Block -->
	<div
		class="col-span-full col-start-2 row-start-2 mb-8 flex flex-col gap-8 text-balance text-stone-600 *:row-span-1 *:flex *:flex-col sm:col-span-3 sm:col-start-4 md:row-start-1"
	>
